...
class EFriendRelationship(Enum):
    constants = {
        'none': 0,
        'Blocked': 1,
        'RequestRecipient': 2,
...
class EIntroducerRouting(Enum):
    constants = {
        'P2PVoiceChat': 1,
        'P2PNetworking': 2,
    }
    
class EServerFlags(Enum):
    constants = {
        'none': 0,
        'Active': 1,
        'Secure': 2,
...
class EAuthSessionResponse(Enum):
    constants = {
        'OK': 0,
...
class EChatRoomEnterResponse(Enum):
    constants = {
        'Success': 1,
        'DoesntExist': 2,
        'NotAllowed': 3,
...
class EContentDownloadSourceType(Enum):
    constants = {
        'Invalid': 0,
        'CS': 1,
        'CDN': 2,
...
class EActivationCodeClass(Enum):
    constants = {
        'WonCDKey': 0,
        'ValveCDKey': 1,
        'Doom3CDKey': 2,
...
class EChatMemberStateChange(Enum):
    constants = {
        'Entered': 0x01,
        'Left': 0x02,
        'Disconnected': 0x04,
...
class EWorkshopEnumerationType(Enum):
    constants = {
        'RankedByVote': 0,
        'Recent': 1,
        'Trending': 2,
...
class EPublishedFileVisibility(Enum):
    constants = {
        'Public': 0,
        'FriendsOnly': 1,
        'Private': 2,
...
class EWorkshopFileAction(Enum):
    constants = {
        'Played': 0,
        'Completed': 1,
    }
    
class EEconTradeResponse(Enum):
    constants = {
        'Accepted': 0,
        'Declined': 1,
...
class EMarketingMessageFlags(Enum):
    constants = {
        'none': 0,
        'HighPriority': 1,
        'PlatformWindows': 2,
...
class ERemoteStoragePlatform(Enum):
    constants = {
        'none': 0,
        'Windows': 1,
        'OSX': 2,
...
class EDRMBlobDownloadType(Enum):
    constants = {
        'Error': 0,
        'File': 1,
        'Parts': 2,
...
class EDRMBlobDownloadErrorDetail(Enum):
    constants = {
        'none': 0,
        'DownloadFailed': 1,
        'TargetLocked': 2,
...
class EClientStatAggregateMethod(Enum):
    constants = {
        'LatestOnly': 0,
        'Sum': 1,
        'Event': 2,
...
class ELeaderboardDataRequest(Enum):
    constants = {
        'Global': 0,
        'GlobalAroundUser': 1,
        'Friends': 2,
...
class ELeaderboardSortMethod(Enum):
    constants = {
        'none': 0,
        'Ascending': 1,
        'Descending': 2,
...
class EUCMFilePrivacyState(Enum):
    constants = {
        'Invalid': -1,
        'Private': 2,
        'FriendsOnly': 4,
...
class UdpHeader(Message):
    constants = {
        'MAGIC': 0x31305356,
    }
    properties = (
        ('magic', 'uint', 0x31305356),
        ('payloadSize', 'ushort', 0),
        ('packetType', 'byte', EUdpPacketType.Invalid),
        ('flags', 'byte', 0),
        ('sourceConnID', 'uint', 512),
        ('destConnID', 'uint', 0),
        ('seqThis', 'uint', 0),
        ('seqAck', 'uint', 0),
        ('packetsInMsg', 'uint', 0),
...
class ChallengeData(Message):
    constants = {
        'CHALLENGE_MASK': 0xA426DF2B,
    }
    properties = (
        ('challengeValue', 'uint', 0),
        ('serverLoad', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class ConnectData(Message):
    constants = {
...
class MsgHdr(Message):
    properties = (
        ('msg', 'int', EMsg.Invalid),
        ('targetJobID', 'ulong', 18446744073709551615),
        ('sourceJobID', 'ulong', 18446744073709551615),
    )
    struct = generate_struct(properties)
    
class ExtendedClientMsgHdr(Message):
    properties = (
        ('msg', 'int', EMsg.Invalid),
        ('headerSize', 'byte', 36),
        ('headerVersion', 'ushort', 2),
        ('targetJobID', 'ulong', 18446744073709551615),
        ('sourceJobID', 'ulong', 18446744073709551615),
...
class MsgHdrProtoBuf(Message):
    properties = (
        ('msg', 'int', EMsg.Invalid),
        ('headerLength', 'int', 0),
        ('proto', 'SteamKit2.Internal.CMsgProtoBufHeader', 0),
    )
    struct = generate_struct(properties)
    
class MsgGCHdrProtoBuf(Message):
    properties = (
        ('msg', 'uint', 0),
        ('headerLength', 'int', 0),
        ('proto', 'SteamKit2.GC.Internal.CMsgProtoBufHeader', 0),
    )
    struct = generate_struct(properties)
    
class MsgGCHdr(Message):
    properties = (
        ('headerVersion', 'ushort', 1),
        ('targetJobID', 'ulong', 18446744073709551615),
        ('sourceJobID', 'ulong', 18446744073709551615),
    )
    struct = generate_struct(properties)
    
class MsgClientJustStrings(Message):
    pass
    
class MsgClientGenericResponse(Message):
    properties = (
        ('result', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgChannelEncryptRequest(Message):
    constants = {
        'PROTOCOL_VERSION': 1,
    }
    properties = (
        ('protocolVersion', 'uint', 1),
        ('universe', 'int', EUniverse.Invalid),
    )
    struct = generate_struct(properties)
    
class MsgChannelEncryptResponse(Message):
    properties = (
        ('protocolVersion', 'uint', MsgChannelEncryptRequest.PROTOCOL_VERSION),
        ('keySize', 'uint', 128),
    )
    struct = generate_struct(properties)
    
class MsgChannelEncryptResult(Message):
    properties = (
        ('result', 'int', EResult.Invalid),
    )
    struct = generate_struct(properties)
    
class MsgClientNewLoginKey(Message):
    properties = (
        ('uniqueID', 'uint', 0),
        ('loginKey', 'byte<20>', 0),
    )
...
class MsgClientNewLoginKeyAccepted(Message):
    properties = (
        ('uniqueID', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientLogon(Message):
    constants = {
        'ObfuscationMask': 0xBAADF00D,
        'CurrentProtocol': 65579,
        ...
        'ProtocolVerMinorMinForSessionIDLastAnon': 36,
        'ProtocolVerMinorMinForEnhancedAppList': 40,
        'ProtocolVerMinorMinForGzipMultiMessages': 43,
    }
    
class MsgClientVACBanStatus(Message):
    properties = (
        ('numBans', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientAppUsageEvent(Message):
    properties = (
        ('appUsageEvent', 'int', 0),
        ('gameID', 'ulong', 0),
        ('offline', 'ushort', 0),
...
class MsgClientEmailAddrInfo(Message):
    properties = (
        ('passwordStrength', 'uint', 0),
        ('flagsAccountSecurityPolicy', 'uint', 0),
        ('validated', 'byte', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientUpdateGuestPassesList(Message):
    properties = (
        ('result', 'int', 0),
        ('countGuestPassesToGive', 'int', 0),
        ('countGuestPassesToRedeem', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientRequestedClientStats(Message):
    properties = (
        ('countStats', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientP2PIntroducerMessage(Message):
    properties = (
        ('steamID', 'ulong', 0),
        ('routingType', 'int', 0),
        ('data', 'byte<1450>', 0),
...
class MsgClientOGSBeginSession(Message):
    properties = (
        ('accountType', 'byte', 0),
        ('accountId', 'ulong', 0),
        ('appId', 'uint', 0),
...
class MsgClientOGSBeginSessionResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('collectingAny', 'byte', 0),
        ('collectingDetails', 'byte', 0),
        ('sessionId', 'ulong', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientOGSEndSession(Message):
    properties = (
        ('sessionId', 'ulong', 0),
        ('timeEnded', 'uint', 0),
        ('reasonCode', 'int', 0),
        ('countAttributes', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientOGSEndSessionResponse(Message):
    properties = (
        ('result', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientOGSWriteRow(Message):
    properties = (
        ('sessionId', 'ulong', 0),
        ('countAttributes', 'int', 0),
    )
...
class MsgClientGetFriendsWhoPlayGame(Message):
    properties = (
        ('gameId', 'ulong', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientGetFriendsWhoPlayGameResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('gameId', 'ulong', 0),
        ('countFriends', 'uint', 0),
...
class MsgGSPerformHardwareSurvey(Message):
    properties = (
        ('flags', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSGetPlayStatsResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('rank', 'int', 0),
        ('lifetimeConnects', 'uint', 0),
        ('lifetimeMinutesPlayed', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSGetReputationResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('reputationScore', 'uint', 0),
        ('banned', 'byte', 0),
        ('bannedIp', 'uint', 0),
        ('bannedPort', 'ushort', 0),
        ('bannedGameId', 'ulong', 0),
        ('timeBanExpires', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSDeny(Message):
    properties = (
        ('steamId', 'ulong', 0),
        ('denyReason', 'int', 0),
    )
...
class MsgGSApprove(Message):
    properties = (
        ('steamId', 'ulong', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSKick(Message):
    properties = (
        ('steamId', 'ulong', 0),
        ('denyReason', 'int', 0),
        ('waitTilMapChange', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSGetUserGroupStatus(Message):
    properties = (
        ('steamIdUser', 'ulong', 0),
        ('steamIdGroup', 'ulong', 0),
    )
    struct = generate_struct(properties)
    
class MsgGSGetUserGroupStatusResponse(Message):
    properties = (
        ('steamIdUser', 'ulong', 0),
        ('steamIdGroup', 'ulong', 0),
        ('clanRelationship', 'int', 0),
        ('clanRank', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientJoinChat(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('isVoiceSpeaker', 'byte', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientChatEnter(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('steamIdFriend', 'ulong', 0),
        ('chatRoomType', 'int', 0),
        ('steamIdOwner', 'ulong', 0),
        ('steamIdClan', 'ulong', 0),
        ('chatFlags', 'byte', 0),
        ('enterResponse', 'int', 0),
        ('numMembers', 'int', 0),
...
class MsgClientChatMsg(Message):
    properties = (
        ('steamIdChatter', 'ulong', 0),
        ('steamIdChatRoom', 'ulong', 0),
        ('chatMsgType', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientChatMemberInfo(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('type', 'int', 0),
    )
...
class MsgClientChatAction(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('steamIdUserToActOn', 'ulong', 0),
        ('chatAction', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientChatActionResult(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('steamIdUserActedOn', 'ulong', 0),
        ('chatAction', 'int', 0),
        ('actionResult', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientChatRoomInfo(Message):
    properties = (
        ('steamIdChat', 'ulong', 0),
        ('type', 'int', 0),
    )
...
class MsgClientSetIgnoreFriend(Message):
    properties = (
        ('mySteamId', 'ulong', 0),
        ('steamIdFriend', 'ulong', 0),
        ('ignore', 'byte', 0),
...
class MsgClientSetIgnoreFriendResponse(Message):
    properties = (
        ('unknown', 'ulong', 0),
        ('result', 'int', 0),
    )
...
class MsgClientLoggedOff(Message):
    properties = (
        ('result', 'int', 0),
        ('secMinReconnectHint', 'int', 0),
        ('secMaxReconnectHint', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientLogOnResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('outOfGameHeartbeatRateSec', 'int', 0),
        ('inGameHeartbeatRateSec', 'int', 0),
        ('clientSuppliedSteamId', 'ulong', 0),
        ('ipPublic', 'uint', 0),
        ('serverRealTime', 'uint', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientSendGuestPass(Message):
    properties = (
        ('giftId', 'ulong', 0),
        ('giftType', 'byte', 0),
        ('accountId', 'uint', 0),
...
class MsgClientSendGuestPassResponse(Message):
    properties = (
        ('result', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientServerUnavailable(Message):
    properties = (
        ('jobidSent', 'ulong', 0),
        ('eMsgSent', 'uint', 0),
        ('eServerTypeUnavailable', 'int', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientCreateChat(Message):
    properties = (
        ('chatRoomType', 'int', 0),
        ('gameId', 'ulong', 0),
        ('steamIdClan', 'ulong', 0),
        ('permissionOfficer', 'int', 0),
        ('permissionMember', 'int', 0),
        ('permissionAll', 'int', 0),
        ('membersMax', 'uint', 0),
        ('chatFlags', 'byte', 0),
        ('steamIdFriendChat', 'ulong', 0),
        ('steamIdInvited', 'ulong', 0),
    )
    struct = generate_struct(properties)
    
class MsgClientCreateChatResponse(Message):
    properties = (
        ('result', 'int', 0),
        ('steamIdChat', 'ulong', 0),
        ('chatRoomType', 'int', 0),
...
class MsgClientMarketingMessageUpdate2(Message):
    properties = (
        ('marketingMessageUpdateTime', 'uint', 0),
        ('count', 'uint', 0),
    )
    struct = generate_struct(properties)
