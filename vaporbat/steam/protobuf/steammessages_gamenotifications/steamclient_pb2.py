...
CGameNotifications_Variable = _reflection.GeneratedProtocolMessageType('CGameNotifications_Variable', (_message.Message,), dict(
  ...
  __module__ = 'steammessages_gamenotifications.steamclient_pb2'
